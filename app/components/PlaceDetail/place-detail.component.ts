...
export class PlaceDetailComponent implements OnInit {
    ...
    constructor(private weatherService: WeatherService, private routeParams: Params, private router: Router) {
        this.cities = [];
    }
                    ...
                    $this.weatherService.getCityForecast(city).then(
                        (forecast: any) => {
                            ...
                            forecast.list.forEach((day: any) => {
                                ...
                                chartData.yValues.data.push({y: parseInt(new Temperature().transform(day.temp.day)),
